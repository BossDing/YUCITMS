...
<body>
    ...
    <div class="formtitle"><span>扩展应用</span></div>
    <form id="form1" action="expandApplication_updateExpandApplication.action?id=${id}&courseId=${courseId}" method="post" enctype="multipart/form-data" onsubmit="javascript:if(!confirm('确实要操作吗？'))return false;">
    <ul class="forminfo">
    <li><label>扩展应用</label><s:textfield name="name" type="text" cssClass="dfinput" /><i></i></li>
