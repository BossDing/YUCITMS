...
<body>
    ...
    <form id="form1" action="qdifficulty_updateDifficulty.action?id=${id}" method="post" enctype="multipart/form-data">
    <ul class="forminfo">
    <li><label>难易</label><s:textfield name="difficulty" type="text" cssClass="dfinput" /><i></i></li>
   <li>
