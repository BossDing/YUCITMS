...
<body>
    ...
    <div class="formtitle"><span>试卷分组</span></div>
    <form id="form1" action="paperGrouping_updatePaperGrouping.action?id=${id}" method="post">
    <ul class="forminfo">
    <li><label>试卷分组</label><s:textfield name="paperGrouping" type="text" cssClass="dfinput" /><i></i></li>
    <li>
