...
<body>
<form name ="addAttendance" id ="addAttendance"  action="practicalTraining_addTemplate.action" method="post" enctype="multipart/form-data" target="rightFrame">
    <div class="formbody">
    
    <div class="formtitle"><span>新增模板</span></div>
    
    <ul class="forminfo">
    <li><label>模板名称</label><input name="practicalTrainingTemplate.templateName" type="text" class="dfinput" /><i>项目名称不能超过30个字符</i></li>
    <li><label>技术类型</label><input name="practicalTrainingTemplate.technologicalType" type="text" class="dfinput" /><i>多个技术用,隔开</i></li>
<!--     <li><label>是否审核</label><cite><input name="" type="radio" value="" checked="checked" />是&nbsp;&nbsp;&nbsp;&nbsp;<input name="" type="radio" value="" />否</cite></li> -->
    <li><label>实训模板</label><input name="upload" type="file"   accept=".*"/><i>实训模板(请打包上传)</i></li>
    <li><label>降级模板</label><input name="upload2" type="file"   accept="rar,.zip"/><i>降级模板(请打包上传)</i></li>
