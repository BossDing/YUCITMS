var foucsbox = function() {
    var $ = function(id) {
        return document.getElementById(id);
    }, topCon = $('divimgplay'), samll = $('divpageinfog_imgPlayer'), tip = $('ptitleg_imgPlayer'), samllimgs = samll
            .getElementsByTagName('li'), slide = function(z) {
    ...
    }, lastIndex = i = 0, x, y = samllimgs.length, getPrevI = function(q) {
