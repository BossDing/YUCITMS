...
<body>
    ...
    <form id="form1" action="video_addExcellentVideo.action?courseId=${courseId}" method="post" enctype="multipart/form-data" onsubmit="javascript:if(!confirm('确实要操作吗？'))return false;">
    <ul class="forminfo">
    <li><label>视频名称</label><input name="videoName" type="text" class="dfinput" /><i>标题不能超过30个字符</i></li>
    <li><label>视频缩略图</label><input name="uploadimg" type="file" class="dfinput" accept="image/jpeg,image/x-png"/></li>
    <li><label>视频(支持MP4、FLV)</label><input name="upload" type="file" class="dfinput" accept=".mp4,.flv"/></li>
