...
<body>
    ...
    <div class="formtitle"><span>添加资料</span></div>
    <form id="form1" action="data_addReferenceData.action?courseId=${courseId}" method="post" enctype="multipart/form-data" onsubmit="javascript:if(!confirm('确实要操作吗？'))return false;">
    <ul class="forminfo">
    <li><label>资料名称</label><input name="referenceName" type="text" class="dfinput" /><i>标题不能超过30个字符</i></li>
