...
<body>
    ...
    <form id="form1" action="course_addCourse5.action?id=${id}&flag=${flag}" method="post" enctype="multipart/form-data">
    <ul class="forminfo">
   <li><label>教学目的</label><s:textarea name="teachingAim" cols="" rows="" cssClass="textinput"></s:textarea></li>
   <li><label>教学要求</label><s:textarea name="teachingRequire" cols="" rows="" cssClass="textinput"></s:textarea></li>
   <li><label>课时安排</label><s:textarea id="content7" name="scheduling" cssStyle="width:700px;height:250px;visibility:hidden;"></s:textarea></li>
    
   <li>
   <label>&nbsp;</label><input type="button" class="btn"  onclick="javascript:window.history.back(-1);"  value="上一步"/>
    <label>&nbsp;</label><input type="submit" class="btn"  value="下一步"/>
    </li>
    </ul>
    </form>
