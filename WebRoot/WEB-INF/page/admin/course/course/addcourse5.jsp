...
<script type="text/javascript" src="${pageContext.request.contextPath}/excellentCourseStyle/excellentCourseStyle/js/jquery.js"></script>
...
function next() {
	form1.action="course_updateCourse2.action?id=${id}&flag=${flag}";
}
</script>
</head>
...
<body>
    ...
    <div class="formtitle"><span>教学大纲</span></div>
    <form id="form1" action="course_addCourse6.action?id=${id}&flag=${flag}" method="post" enctype="multipart/form-data">
    <ul class="forminfo">
   <li><label>实训</label><s:textarea id="content7" name="practice" cssStyle="width:700px;height:250px;visibility:hidden;"></s:textarea></li>
   <li><label>作业</label><s:textarea id="content8" name="work" cssStyle="width:700px;height:250px;visibility:hidden;"></s:textarea></li>
   ...
   <s:else><label>&nbsp;</label><input type="submit" class="btn" onclick="next();" value="完成"/></s:else>
