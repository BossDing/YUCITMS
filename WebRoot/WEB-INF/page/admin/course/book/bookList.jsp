...
<body>
 ...
 <li><a href="course_getCourse.action?id=${courseId}">工作台</a></li>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
       <a href="book_addLessonBookPage.action?courseId=${courseId}"><li class="click"><span><img src="${pageContext.request.contextPath}/excellentCourseStyle/images/t01.png" /></span>添加</li></a>
    ...
    <li class="selected">
    <a onclick="dialog('<%=Config.EXCELLENTCOURSE_ImgPath%>/${imgPath}','${bookName}','${author}','${publishingHouse}<br>${bookCode}','${id}');"><span><img src="<%=Config.EXCELLENTCOURSE_ImgPath%>/${imgPath}" height="130px" width="175px"/></span>
    <h2>
    ...
    <p><a href="book_updateLessonBookPage.action?id=${id}&courseId=${courseId}">编辑</a>
    &nbsp;&nbsp;&nbsp;&nbsp;
    <a href="book_deleteLessonBook.action?id=${id}&courseId=${courseId}">删除</a></p>
    </li>
