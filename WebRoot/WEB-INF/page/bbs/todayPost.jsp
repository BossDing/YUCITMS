...
<body>
    <header class="head box-shdow bg-style">
        ...
        <div class="center">
            ...
            <img id="myquestion" style="cursor: pointer;" onclick="javascript:location.href='<%=basePath%>/bbsStyle/bbs_myPosts.asp'" src="<%=basePath%>/bbsStyle/images/my_question.png" />
    ...
    <s:form action="bbs_todayBbs" method="post" name="page">
