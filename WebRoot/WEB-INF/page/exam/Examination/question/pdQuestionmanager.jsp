...
<body>
    ...
    <table class="tablelist">
        ...
        <td>     <a onclick="update('question_updatePanDuanPage.action?id=${id}&pageNum=${pageNum}');" class="tablelink">编辑</a></td>
        </tr>   
        </s:iterator>     
        </tbody>
    </table>
     
    <s:form action="questionManager_getPDquestionList" name="page">
