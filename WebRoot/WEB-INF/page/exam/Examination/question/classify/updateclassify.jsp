...
<body>
    ...
    <div class="formtitle"><span>试题分类</span></div>
    <form id="form1" action="classify_updateclassify.action?id=${id}" method="post">
    <ul class="forminfo">
    <li><label>分类</label><s:textfield name="classify" type="text" cssClass="dfinput" /><i></i></li>
    <li>
