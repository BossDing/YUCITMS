...
<body>
    ...
    <div class="formtitle"><span>试题分组</span></div>
    <form id="form1" action="grouping_addGrouping.action" method="post" enctype="multipart/form-data">
    <ul class="forminfo">
    <li><label>试题分组</label><input name="grouping" type="text" class="dfinput" /><i>标题不能超过30个字符</i></li>
    <li>
