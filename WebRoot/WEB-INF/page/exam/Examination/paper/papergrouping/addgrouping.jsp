...
<body>
    ...
    <form id="form1" action="paperGrouping_addPaperGrouping.action" method="post" >
    <ul class="forminfo">
    <li><label>试卷分组</label><input name="paperGrouping" type="text" class="dfinput" /><i>标题不能超过30个字符</i></li>
    <li>
