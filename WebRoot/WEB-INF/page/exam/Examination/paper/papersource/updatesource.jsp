...
<body>
    ...
    <div class="formtitle"><span>试卷来源</span></div>
    <form id="form1" action="paperSource_updatePaperSource.action?id=${id}" method="post">
    <ul class="forminfo">
    <li><label>试卷来源</label><s:textfield name="paperSource" type="text" cssClass="dfinput" /><i></i></li>
    <li>
