...
<body>
    ...
    <form id="form1" action="paperSource_addPaperSource.action" method="post" >
    <ul class="forminfo">
    <li><label>试卷来源</label><input name="paperSource" type="text" class="dfinput" /><i>标题不能超过30个字符</i></li>
    <li>
