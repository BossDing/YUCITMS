...
<body>
    ...
    <form id="form1" action="papegClassify_addPaperClassify.action" method="post" >
    <ul class="forminfo">
    <li><label>试卷分类</label><input name="paperClassify" type="text" class="dfinput" /><i>标题不能超过30个字符</i></li>
    <li>
   <label>&nbsp;</label><input type="button" class="btn"  onclick="javascript:window.history.back(-1);"  value="上一步"/>
    <label>&nbsp;</label><input type="submit" class="btn"  value="完成"/>
    </li>
    </ul>
    </form>
